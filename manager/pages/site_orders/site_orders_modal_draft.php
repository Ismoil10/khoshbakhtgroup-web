...
<!-- ADD REQUEST Modal -->
<div class="modal fade" id="vacancies_edit_form_modal" tabindex="-1" role="dialog" aria-labelledby="taskModalLabel">
...
<div class="modal fade" id="file_add_form_modal" tabindex="-1" role="dialog" aria-labelledby="taskModalLabel">
  ...
  $fields = [
    ...
    ['name' => 'name__vacancies', 'type' => 'text', 'sort' => '100'],
    ['name' => 'category_vacancies', 'type' => 'text', 'sort' => '200'],
    ['name' => 'employment_vacancies', 'type' => 'text', 'sort' => '300'],
    ['name' => 'requirements_list1', 'type' => 'text', 'sort' => '400'],
    ['name' => 'requirements_list2', 'type' => 'text', 'sort' => '450'],
    ['name' => 'requirements_list3', 'type' => 'text', 'sort' => '500'],
    ['name' => 'requirements_list4', 'type' => 'text', 'sort' => '600'],
    ['name' => 'requirements_list5', 'type' => 'text', 'sort' => '700'],
    ['name' => 'requirements_list6', 'type' => 'text', 'sort' => '800'],
    ['name' => 'tasks_list1', 'type' => 'text', 'sort' => '900'],
    ['name' => 'tasks_list2', 'type' => 'text', 'sort' => '1000'],
    ['name' => 'tasks_list3', 'type' => 'text', 'sort' => '1100'],
    ['name' => 'work_list', 'type' => 'text', 'sort' => '1200']
  ];
    ...
    <form method="POST" action="">
      <div class="modal-content">
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="form-group">
                <label class="control-label">Actively</label>
              ...
              <? foreach ($fields as $v) : ?>
                ...
                <? elseif ($v['type'] == 'file') : ?>
                  ...
                  <label class="control-label"><?= $v['name'] ?> (file)</label><br>
        ...
        <div class="modal-footer">
          <button type="submit" class="btn btn-primary" name="vacancies_add_form">Add</button>
  ...
  <div class="modal-dialog" role="document">
    ...
    <form method="POST" action="">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="submit" class="btn btn-primary" name="vacancies_del_form">Yes</button>
...
if (isset($_POST['vacancies_add_form'])) {
  ...
  $q['ins'] = db::query("INSERT INTO `vacancies_det` (
 `SORT`,
 `DATE_CREATED`, 
 `LANG`,
 `name__vacancies`,
 `category_vacancies`,
 `employment_vacancies`, 
 `requirements_list1`,
 `requirements_list2`,  
 `requirements_list3`, 
 `requirements_list4`, 
...
'$_POST[sort]',
	now(), 
'$_POST[lang]', 
'$_POST[name__vacancies]', 
'$_POST[category_vacancies]', 
'$_POST[employment_vacancies]', 
'$_POST[requirements_list1]', 
'$_POST[requirements_list2]', 
'$_POST[requirements_list3]', 
'$_POST[requirements_list4]', 
'$_POST[requirements_list5]', 
'$_POST[requirements_list6]', 
'$_POST[tasks_list1]', 
'$_POST[tasks_list2]', 
'$_POST[tasks_list3]', 
'$_POST[work_list]')");
...
if (isset($_POST['vacancies_del_form'])) {
  $id = $_POST['del_file_id'];
  $q['del'] = db::query("DELETE FROM vacancies_det WHERE ID='$id'");
  LocalRedirect('index.php');
}

if (isset($_POST['vacancies_edit_form'])) {
  foreach ($_POST as $k => $v) {
    $_POST[$k] = str_replace("'", "\'", $v);
  }

  $q['upd'] = db::query(" 
UPDATE `vacancies_det` SET
`SORT` = '$_POST[sort]',
`DATE_CREATED` = now(),
`LANG` = '$_POST[lang]',
`name__vacancies` = '$_POST[name__vacancies]',
`category_vacancies` = '$_POST[category_vacancies]',
`employment_vacancies` = '$_POST[employment_vacancies]',
`requirements_list1` = '$_POST[requirements_list1]',
`requirements_list2` = '$_POST[requirements_list2]',
`requirements_list3` = '$_POST[requirements_list3]',
`requirements_list4` = '$_POST[requirements_list4]',
`requirements_list5` = '$_POST[requirements_list5]',
`requirements_list6` = '$_POST[requirements_list6]',
`tasks_list1` = '$_POST[tasks_list1]',
`tasks_list2` = '$_POST[tasks_list2]',
`tasks_list3` = '$_POST[tasks_list3]',
`work_list` = '$_POST[work_list]'
WHERE `ID` = '$_POST[vacancies_id]'");
