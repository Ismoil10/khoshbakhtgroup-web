    ...
    <form method="POST" action="">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="submit" class="btn btn-primary" name="vacancies_add_form">Добавить</button>
  ...
  <div class="modal-dialog" role="document">
    ...
    <form method="POST" action="">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="submit" class="btn btn-primary" name="vacancies_del_form">Да</button>
