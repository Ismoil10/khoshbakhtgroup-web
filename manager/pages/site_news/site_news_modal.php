...
<div class="modal fade" id="file_add_form_modal" tabindex="-1" role="dialog" aria-labelledby="taskModalLabel">
  ...
  $fields = [
    ...
    ['name' => 'text_short', 'type' => 'text', 'sort' => '150'],
    ['name' => 'title_long', 'type' => 'text', 'sort' => '180'],
    ['name' => 'img', 'type' => 'file', 'sort' => '200'],
    ['name' => 'section', 'type' => 'text', 'sort' => '250'],

    ['name' => 'title', 'type' => 'text', 'sort' => '300'],
    ['name' => 'title_text1', 'type' => 'text', 'sort' => '350'],
    ['name' => 'title_text2', 'type' => 'text', 'sort' => '400'],
    ['name' => 'title_text3', 'type' => 'text', 'sort' => '450'],
    ['name' => 'title_text4', 'type' => 'text', 'sort' => '500'],

    ['name' => 'title2', 'type' => 'text', 'sort' => '550'],
    ['name' => 'title2_text1', 'type' => 'text', 'sort' => '600'],
    ['name' => 'title2_text2', 'type' => 'text', 'sort' => '650'],
    ['name' => 'title2_text3', 'type' => 'text', 'sort' => '700'],
    ['name' => 'title2_text4', 'type' => 'text', 'sort' => '750'],

    ['name' => 'title3', 'type' => 'text', 'sort' => '800'],
    ['name' => 'title3_text1', 'type' => 'text', 'sort' => '850'],
    ['name' => 'title3_text2', 'type' => 'text', 'sort' => '900'],
    ['name' => 'title3_text3', 'type' => 'text', 'sort' => '1000'],
    ['name' => 'title3_text4', 'type' => 'text', 'sort' => '1050'],

    ['name' => 'title4', 'type' => 'text', 'sort' => '1100'],
    ['name' => 'title4_text1', 'type' => 'text', 'sort' => '1150'],
    ['name' => 'title4_text2', 'type' => 'text', 'sort' => '1200'],
    ['name' => 'title4_text3', 'type' => 'text', 'sort' => '1250'],
    ['name' => 'title4_text4', 'type' => 'text', 'sort' => '1300'],

    ['name' => 'img2', 'type' => 'file', 'sort' => '1350'],
    
    ['name' => 'read', 'type' => 'text', 'sort' => '1400'],
...
if (isset($_POST['news_del_form'])) {
  ...
  $q['del'] = db::query("DELETE FROM news WHERE ID='$id'");
  LocalRedirect('index.php');
}
...
// `TITLE` = '$_POST[title]',
// `TITLE_TEXT1` = '$_POST[title_text1]',
// `TITLE_TEXT2` = '$_POST[title_text2]',
// `TITLE_TEXT3` = '$_POST[title_text3]',
// `TITLE_TEXT4` = '$_POST[title_text4]',
// `TITLE2` = '$_POST[title2]',
// `TITLE2_TEXT1` = '$_POST[title2_text1]',
// `TITLE2_TEXT2` = '$_POST[title2_text2]',
// `TITLE2_TEXT3` = '$_POST[title2_text3]',
// `TITLE2_TEXT4` = '$_POST[title2_text4]',
// `TITLE3` = '$_POST[title3]',
// `TITLE3_TEXT1` = '$_POST[title3_text1]',
// `TITLE3_TEXT2` = '$_POST[title3_text2]',
// `TITLE3_TEXT3` = '$_POST[title3_text3]',
// `TITLE3_TEXT4` = '$_POST[title3_text4]',
// `TITLE4` = '$_POST[title4]',
// `TITLE4_TEXT1` = '$_POST[title4_text1]',
// `TITLE4_TEXT2` = '$_POST[title4_text2]',
// `TITLE4_TEXT3` = '$_POST[title4_text3]',
// `TITLE4_TEXT4` = '$_POST[title4_text4]',
// `IMG2` = '$_POST[img2]',
// `READ` = '$_POST[read]'
