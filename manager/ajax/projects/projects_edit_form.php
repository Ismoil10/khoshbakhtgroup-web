...
[ 'name' => 'text_short', 'name_db'=>'TEXT_SHORT', 'type' => 'text','sort' => '200' ],
[ 'name' => 'logo', 'name_db'=>'LOGO', 'type' => 'file','sort' => '300' ],
[ 'name' => 'title_type', 'name_db'=>'TITLE_TYPE', 'type' => 'text','sort' => '400' ],
[ 'name' => 'title_company', 'name_db'=>'TITLE_COMPANY', 'type' => 'text','sort' => '450' ],
[ 'name' => 'title_long', 'name_db'=>'TITLE_LONG', 'type' => 'text','sort' => '500' ],
[ 'name' => 'text', 'name_db'=>'TEXT', 'type' => 'text','sort' => '600' ],
[ 'name' => 'list1', 'name_db'=>'LIST1', 'type' => 'text','sort' => '700' ],
[ 'name' => 'list2', 'name_db'=>'LIST2', 'type' => 'text','sort' => '800' ],
[ 'name' => 'list3', 'name_db'=>'LIST3', 'type' => 'text','sort' => '900' ],
[ 'name' => 'link_text', 'name_db'=>'LINK_TEXT', 'type' => 'text','sort' => '1000' ],
[ 'name' => 'link', 'name_db'=>'LINK', 'type' => 'text','sort' => '1100' ],
[ 'name' => 'screenshot1', 'name_db'=>'SCREENSHOT1', 'type' => 'file','sort' => '1200' ],
[ 'name' => 'screenshot2', 'name_db'=>'SCREENSHOT2', 'type' => 'file','sort' => '1300' ],
[ 'name' => 'screenshot3', 'name_db'=>'SCREENSHOT3', 'type' => 'file','sort' => '1400' ]
];
?>


<?
$content_data = db::arr_s("SELECT * FROM projects WHERE ID='$_POST[projects_id]'");
?>
  ...
  <div class="modal-dialog" role="document">
	    ...
	    <div class="modal-content">
            ...
            <div class="modal-body" >              
	            ...
	            <div class="row">
						...
						<input type="hidden" name="projects_id" value="<?=$_POST['projects_id']?>">
	...
	['view', ['fullscreen', 'codeview', 'help']]
			...
			<div class="modal-footer"> 
              <button type="submit" class="btn btn-primary" name="projects_edit_form">Редактировать</button>			
