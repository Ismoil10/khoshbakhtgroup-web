                        ...
                        <div class="col-lg-12">
                            <div class="header-middle-wrap position-relative">
                                ...
                                <div class="main-menu d-none d-lg-block custom-navbar">
                                    <nav class="main-nav">
                                        <ul class="flex-direct">
                                            <? $select_content = view::CONTENT('all_active', ['IBLOCK_ID' => '2']);?>
                                            <? foreach($select_content as $v): ?>                              
                                                <? //echo '<pre>'; print_r($select_content); echo '</pre>'; ?>
                                                <? if ($v["name_ar"] == "العلامات التجارية") : ?>
                                                    <li class="drop-holder p-left">
