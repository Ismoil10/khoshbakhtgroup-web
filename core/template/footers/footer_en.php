		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					...
					<span class="copyright-text">© <?= date("Y") ?> Khoshbakhtgroup Company</span>
					<span class="copyright-text"><a href="https://evosoft-solutions.com/" target="_blank">Powered by Evosoft Solutions</a></span>
					</div>
				</div>
			</div>
		</div>
