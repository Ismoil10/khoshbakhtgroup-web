...
<main class="main-content">
  <div class="breadcrumb-area breadcrumb-height-a">
      ...
      <div class="row h-100">
        <div class="col-lg-12">
          ...
          <? foreach($select_products as $v): ?>
            <h2 class="breadcrumb-heading head-text"><?=$v['NAME_EN']?></h2>
            <ul>
              <li>
  ...
  <!--single-product-area section-space-top-100-->
  <div class="single-product-area section-space-top-s1">
    <div class="container">
      <div class="row">
      <? foreach($select_products as $v):?>
        ...
        <div class="col-lg-6 pt-9 pt-lg-0">
          <div class="single-product-content">
            <h2 class="title mb-3"><?=$v['NAME_EN']?></h2>
            ...
            <p class="short-desc mb-9"><?=$v['DESCRIPTION_EN']?></p>
          </div>
        </div>
      <? endforeach; ?>
      </div>
          ...
          <div class="tab-content product-tab-content">
            <div class="tab-pane fade show active" id="description" role="tabpanel" aria-labelledby="description-tab">
              ...
              <div class="product-description-body">
                <p class="short-desc mb-0"><?=$v['DESCRIPTION_EN']?></p>
              </div>
              <? endforeach; ?>
            </div>
