                ...
                <? foreach ($select_banner as $v) : ?>
                    ...
                    <div class="col-lg-4 col-md-6 shade-border banner-top">
                        <div class="banner-item img-hover-effect box-shadow">
                            <h2 class="title text-color">Последний <br><?= $v['NAME_EN'] ?></h2>
                            <div class="banner-img img-zoom-effect bg-color">
                                ...
                                <div class="inner-content text-white">
                                    <div class="button-wrap">
                                        <a class="btn btn-custom-size btn-primary" href="<?= mdir("product/$str/$v[ID]") ?>">Подробно</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6 col-md-6 shade-border custom-card">
                        <div class="banner-item img-hover-effect box-shadow">
                            ...
                            <div class="banner-img img-zoom-effect bg-color">
                                ...
                                <div class="inner-content text-white">
                                    <div class="button-wrap">
                                        <a class="btn btn-custom-size btn-primary" href="<?= mdir("catalog/$str/category"); ?>">продукты</a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <? foreach (view::CONTENT('all_active', ['IBLOCK_ID' => '22']) as $v) : ?>
            <div class="col-md-6 p-top">
                <div class="section-title" align="left">
                    <h2 class="title title-bottom">О нас</h2>
                </div>
                <div align="left">
                    <?= $v['text_ru']; ?>
                    <div class="button-wrap more-bt">
                        <a class="btn btn-link text-danger with-underline p-0" href="<?= mdir("about"); ?>">Больше о</a>
                    </div>
                </div>
            </div>
        <? endforeach; ?>
    ...
    <div class="product-area section-space-y-axis-100 c-background">
        <div class="container">
            <div class="section-title pb-55">
                <h2 class="title mb-0">СПЕЦИАЛЬНЫЕ ПРЕДЛОЖЕНИЯ</h2>
            </div>
            <div class="row">
                <div class="col-lg-12">
                            ...
                            <div class="col-lg-4 col-md-6 pt-7">
                                <div class="product-item">
                                    ...
                                    <div class="product-content">
                                        <a class="product-name pb-1" href="<?= mdir("product/$str/$v[ID]"); ?>"><?= $v['NAME_RU'] ?></a>
                                    </div>
                                </div>
                            </div>
                        <? endforeach; ?>
                ...
                <div class="col-12 pt-55">
                    <div class="button-wrap">
                        <a class="btn btn-link text-danger with-underline p-0" href="<?= mdir("catalog/asaman/category"); ?>">Посмотреть больше продуктов</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="section-title pt-55 pb-55">
                    <h2 class="title mb-0 partners-title" align="center">наши партнеры</h2>
                </div>
        ...
        <div class="row">
            <div class="contact-form-wrap-post">
                <form id="contact-form" class="contact-form" action="">
                    <h2 class="newsletter-title mb-4">Оставьте свои контакты</h2>
                    <h2 class="newsletter-sub-title text-primary mb-8">И Мы позвоним вам</h2>
                    <div class="group-input">
                        <div class="form-field m-top me-xl-6">
                            <input type="text" autocomplete="off" name="applicationName" id="con_name" placeholder="Имя*" class="input-field" required>
                        </div>
                        <div class="form-field m-top me-xl-6">
                            <input type="text" autocomplete="off" name="applicationPhone" id="con_phone" placeholder="Телефон" class="input-field" required>
                        </div>
                        <div class="form-field m-top me-xl-6">
                            <input type="email" autocomplete="off" name="applicationEmail" id="con_email" placeholder="Эл. почта*" class="input-field" required>
                        </div>
                    </div>
                    <div class="form-field mt-6">
                        <textarea name="applicationMessage" id="con_message" placeholder="Сообщение" class="textarea-field" required></textarea>
                    </div>
                    ...
                    <div class="button-wrap mt-4">
                        <button type="submit" id="post_com" value="submit" formmethod="post" class="btn btn btn-custom-size lg-size btn-primary btn-secondary-hover rounded-0" name="send_message" disabled>Отправить</button>
