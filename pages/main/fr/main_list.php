                ...
                <? foreach ($select_banner as $v) : ?>
                    ...
                    <div class="col-lg-4 col-md-6 shade-border banner-top">
                        <div class="banner-item img-hover-effect box-shadow">
                            <h2 class="title text-color">Dernier <br><?= $v['NAME_FR'] ?></h2>
                            <div class="banner-img img-zoom-effect bg-color">
                                ...
                                <div class="inner-content text-white">
                                    <div class="button-wrap">
                                        <a class="btn btn-custom-size btn-primary" href="<?= mdir("product/$str/$v[ID]") ?>">En savoir plus</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6 col-md-6 shade-border custom-card">
                        <div class="banner-item img-hover-effect box-shadow">
                            ...
                            <div class="banner-img img-zoom-effect bg-color">
                                ...
                                <div class="inner-content text-white">
                                    <div class="button-wrap">
                                        <a class="btn btn-custom-size btn-primary" href="<?= mdir("catalog/$str/category"); ?>">produits</a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <? foreach (view::CONTENT('all_active', ['IBLOCK_ID' => '22']) as $v) : ?>
            <div class="col-md-6 p-top">
                <div class="section-title" align="left">
                    <h2 class="title title-bottom">À propos de nous</h2>
                </div>
                <div align="left">
                    <?= $v['text_fr']; ?>
                    <div class="button-wrap more-bt">
                        <a class="btn btn-link text-danger with-underline p-0" href="<?= mdir("about"); ?>">Plus à propos</a>
                    </div>
                </div>
            </div>
        <? endforeach; ?>
    ...
    <div class="product-area section-space-y-axis-100 c-background">
        <div class="container">
            <div class="section-title pb-55">
                <h2 class="title mb-0">OFFRES SPÉCIALES</h2>
            </div>
            <div class="row">
                <div class="col-lg-12">
                            ...
                            <div class="col-lg-4 col-md-6 pt-7">
                                <div class="product-item">
                                    ...
                                    <div class="product-content">
                                        <a class="product-name pb-1" href="<?= mdir("product/$str/$v[ID]"); ?>"><?= $v['NAME_FR'] ?></a>
                                    </div>
                                </div>
                            </div>
                        <? endforeach; ?>
                ...
                <div class="col-12 pt-55">
                    <div class="button-wrap">
                        <a class="btn btn-link text-danger with-underline p-0" href="<?= mdir("catalog/asaman/category"); ?>">Voir plus de produits</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="section-title pt-55 pb-55">
                    <h2 class="title mb-0 partners-title" align="center">nos partenaires</h2>
                </div>
