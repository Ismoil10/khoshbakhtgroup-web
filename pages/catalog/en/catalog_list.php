  ...
  <div class="shop-area section-space-y-axis-100">
    <div class="container">
      <div class="row">
                      ...
                      <ul class="<? if($ex[1] == $cat['ID']){ echo false;}else{ echo 'sub-menu';}?> custom-border">
                        <li>
                          <a href="<?=mdir("product/$innerPageName/$subc[SID]") ?>">
                            <span class="mm-text"><?=$subc['NAME_EN']?></span>
                          </a>
                        </li>
                      </ul>
            ...
            <div class="widgets-area mb-9 pd-top">
              <h2 class="widgets-title mb-5">Certificates</h2>
                ...
                <ul class="widgets-category">
                  <? //foreach($brand_list as $brand):?>
                    <li>
                      <a href="https://khoshbakhtgroup.com/en/quality-control">Quality control</a>
                    </li>
                  <? //endforeach ?>
                </ul>
              </div>
            ...
            <? foreach($cat_files as $v): ?>
              ...
              <a class="underline-link" href="<?=$get_file['file_1'];?>" download>
                ...
                <div class="middle-s download-topbar">
                    <div class="second-button">Download Catalog</div>
                </div>
              </a> 
              <? endforeach; ?> 
              </div>       
        ...
        <div class="col-xl-9 col-lg-8 order-lg-4 order-2">
          <div class="product-topbar">
            <ul>
              ...
              <li class="page-count margin-count margin-right" align="center">
                 <a class="underline-link" href="<?=$get_file['file_1'];?>" download><i class="fa fa-download" aria-hidden="true"></i> Download Catalog</a>
              </li>
              <? endforeach; ?>
            </ul>
          </div>
                  ...
                  <div class="col-xl-4 col-sm-6 pt-6">
                    <div class="product-item">
                      ...
                      <div class="product-content">
                        <a class="bg-primary p-1 text-light" href="<?=mdir("product/$innerPageName/$v[ID]")?>"><?=$v['NAME_EN']; ?></a>
                      </div>
                    </div>
                  </div>
                <? endforeach; ?>
