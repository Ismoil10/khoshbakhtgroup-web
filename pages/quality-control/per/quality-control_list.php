...
<main class="main-content">
  ...
  <div class="about-banner different-bg-position section-space-y-axis-100">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <h2 class="about-title mb-5 text-center">گواهینامه ها</h2>
        ...
        <div class="col-lg-12 mt-10 row">
          <div class="col-md-6">
            <div class="card border-0">
              <div class="card-header bg-light text-end">گواهی مدیریت</div>
          ...
          <div class="col-md-6">
            <div class="card border-0">
              <div class="card-header bg-light text-end">گواهی کیفیت</div>
        ...
        <div class="col-lg-12 mt-10">
          <div class="about-banner-content text-center section-space-bottom-95">
            <div class="section-title">
              <h2 class="about-title mb-5">کنترل کیفیت</h2>
