...
<main class="main-content">
  ...
  <div class="about-banner different-bg-position section-space-y-axis-100">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <h2 class="about-title mb-5 text-center">Сертификаты</h2>
        ...
        <div class="col-lg-12 mt-10 row">
          <div class="col-md-6">
            <div class="card border-0">
              <div class="card-header bg-light">Сертификат управления:</div>
          ...
          <div class="col-md-6">
            <div class="card border-0">
              <div class="card-header bg-light">Сертификат качества:</div>
        ...
        <div class="col-lg-12 mt-10">
          <div class="about-banner-content text-center section-space-bottom-95">
            <div class="section-title">
              <h2 class="about-title mb-5">Контроль качества</h2>
              ...
              <div class="frequently-item">
                <ul>
                  <li class="has-sub active">
                    <a href="javascript:void(0)">Входной контроль качества
                  ...
                  <li class="has-sub">
                    <a href="javascript:void(0)">Непрерывный контроль качества
                      <i class="pe-7s-angle-down"></i>
                    </a>
                    <ul class="frequently-body">
                      <li>
                  ...
                  <li class="has-sub">
                    <a href="javascript:void(0)">Исходящий контроль качества
                      <i class="pe-7s-angle-down"></i>
                    </a>
                    <ul class="frequently-body">
                      <li>
