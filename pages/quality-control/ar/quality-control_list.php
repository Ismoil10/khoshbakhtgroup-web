...
<main class="main-content">
  ...
  <div class="about-banner different-bg-position section-space-y-axis-100">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <h2 class="about-title mb-5 text-center">الشهادات</h2>
          <div class="card border-0">
            <div class="card-body row">
              <div class="col-md-6">
                <p class="short-desc mb-0 text-end"><?=$main_text["part_1_".$_GET["lang"]]?></p>
              ...
              <div class="col-md-6">
                ...
                <p class="short-desc mb-0 text-end"><?=$main_text["part_2_".$_GET["lang"]]?></p>
              </div>
            </div>
          </div>
        </div>
        <div class="col-lg-12 mt-10 row">
          <div class="col-md-6">
            <div class="card border-0">
              <div class="card-header bg-light text-end">شهادة الإدارة</div>
              <div class="card-body row managment-certificates">
                <? foreach (view::CONTENT('all_active',['IBLOCK_ID'=>'6']) as $v1):?>
                  <div class="col-sm-4 mb-1"><a href="javascript:void(0);" class="ps-5 certificate text-end" data-file-scr="<?=$v1["file"]?>"><?=$v1["name_".$_GET['lang']]?> <i class="pe-7s-note2"></i></a></div>
                <?endforeach?>
              </div>
            </div>
          </div>
          <div class="col-md-6">
            <div class="card border-0">
              <div class="card-header bg-light text-end">شهادة الجودة</div>
              <div class="card-body row quality-certificates">
              <? foreach (view::CONTENT('all_active',['IBLOCK_ID'=>'7']) as $v2):?>
                  <div class="col-sm-4 mb-1"><a href="javascript:void(0);" class="ps-5 certificate text-end" data-file-scr="<?=$v2["file"]?>"><?=$v2["name_".$_GET['lang']]?> <i class="pe-7s-note2"></i></a></div>
                <?endforeach?>
              </div>
            </div>
          </div>
        ...
        <div class="col-lg-12 mt-10">
          <div class="about-banner-content text-center section-space-bottom-95">
            <div class="section-title">
              <h2 class="about-title mb-5">رقابة جودة</h2>
